 ...
 * This number is passed in as a "pointsPerSkill" String configuration value ({@link com.graphaware.reco.generic.context.Context#config()}), defaulting to "1.0".
 */
public class RecruitingPeopleBySkills extends SingleScoreRecommendationEngine<Node, Node> {
