...
package com.chrisshayan.examples.reco.recruiting;
...
/**
 * {@link com.graphaware.reco.generic.filter.Filter} that filters out potentially recommended people that are underage. The minimum legal age is passed
 * in as a "legalAge" String configuration value ({@link com.graphaware.reco.generic.context.Context#config()}), defaulting to "18".
 */
